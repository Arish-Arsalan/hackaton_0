            ...
            <div>
                ...
                <div className=" md:flex-row bg-[#FFFFFF] justify-around mx-auto py-10 px-4">
                    ...
                    <div className="flex flex-wrap justify-center md:justify-start  gap-6 ">
                        {/* Product Item */}
                        {[
                            { src: '/Mask group (2).png', name: 'Trenton modular sofa_3', price: 'Rs. 25,000.00' },
                            { src: '/Mask group (3).png', name: 'Granite dining table with dining chair', price: 'Rs. 25,000.00' },
                            { src: '/Mask group (4).png', name: 'Outdoor bar table and stool', price: 'Rs. 25,000.00' },
                            { src: '/Mask group (5).png', name: 'Plain console with teak', price: 'Rs. 25,000.00' },
                        ].map((item, index) => (
